...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-10 main p-4">
            <h3 class="fw-bold mb-4">라인 출고완료</h3>
                ...
                <table class="table table-bordered text-center align-middle mt-2" style="background-color: #DBFFE8;">
                     <thead style="background-color: #EDFFF4;">
                        <tr>
                            ...
                            <th style="background-color: #EDFFF4;">제품이름</th>
            ...
            <div class="d-flex justify-content-center gap-3">
                <button type="button" class="btn btn-success px-4 py-2" onclick="location.href='${contextPath }/issuing/lineout'">계속하기</button>
