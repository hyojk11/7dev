...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-10 main" style="padding-right: 20px;">
            <h3 class="fw-bold mb-4">부품 출고하기</h3>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #f9f9f9; padding: 12px 20px;">
                                <div class="d-flex align-items-center">
                                    <input type="text" name="product_cnt" class="form-control me-2" placeholder="수량 입력" required style="max-width: 160px; font-size: 1rem; border-radius: 5px; padding: 8px;">
