...
<body>
	...
	<table border="1">
		...
		<tr>
			<td>비밀번호</td>
			<td colspan="2"><input type="text" id="emp_password" name="emp_password" value="${dto.emp_password}" readonly></td>
		</tr>
		<tr>
			<td>전화번호</td>
	...
	<button type="button" id="deleteBtn" onclick="location.href='${contextPath}/emp/delete?emp_no=${dto.emp_no}'">삭제</button>
	<button type="button" id="backBtn" onclick="location.href='${contextPath}/emp/list'">목록으로</button>
	<button type="button" id="cancelBtn" onclick="location.href='${contextPath}/emp/detail?emp_no=${dto.emp_no}'" style="display: none;">취소</button>
	</form>
