				...
				<div class="scroll-container"
					...
					<table
						...
						<thead class="sticky-row">
							<!-- 검색 영역 -->
							<tr
								style="position: sticky; top: 0; background-color: #fff; z-index: 3;">
								<th colspan="4">
							...
							<!-- 목록 헤더 -->
							<tr
								style="position: sticky; top: 56px; background-color: #fff; z-index: 2;">
								<th colspan="3">제품 목록</th>
								<th>
									<button type="button" class="btn btn-success btn-sm"
										onclick="openModal()">품목추가</button>
								</th>
							</tr>

							<!-- 실제 테이블 컬럼 헤더 -->
							<tr
								style="position: sticky; top: 96px; background-color: #fff; z-index: 1;">
									...
									<tr>
										...
										<td>
											<button type="button"
												...
												onclick="location.href='${contextPath}/product/product_bom?productNo=${product.productNo}'">보기</button>
					...
					<form action="${contextPath}/product/createProduct" method="post">
						<div class="form-group">
							<label for="productCode">품목코드</label> <input type="text"
								name="productCode" id="productCode" class="form-control"
								required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="eop">판매여부</label> <select name="eop" id="eop"
								class="form-control">
